        ...
        IParsable<SemVersionRange>
{
    ...
    public static SemVersionRange Empty { get; } =
        new SemVersionRange(ReadOnlyList<UnbrokenSemVersionRange>.Empty);
    ...
    public static SemVersionRange AllRelease { get; } =
        new SemVersionRange(UnbrokenSemVersionRange.AllRelease);
    ...
    public static SemVersionRange GreaterThan(
        SemVersion version,
    ...
    public static SemVersionRange Inclusive(
        SemVersion start,
        SemVersion end,
        bool includeAllPrerelease = false
    ...
    /// not the end.</returns>
    public static SemVersionRange InclusiveOfStart(
        SemVersion start,
        SemVersion end,
        bool includeAllPrerelease = false
    ...
    public static SemVersionRange InclusiveOfEnd(
        SemVersion start,
        SemVersion end,
        bool includeAllPrerelease = false
    ...
    /// <returns>A range containing versions between the given versions including the end but
    /// not the start.</returns>
    public static SemVersionRange Exclusive(
        SemVersion start,
        SemVersion end,
        bool includeAllPrerelease = false
    ...
    public static implicit operator Predicate<SemVersion>(SemVersionRange range) => range.Contains;
...
#pragma warning disable RS0026 // Do not add multiple public overloads with optional parameters
    public static SemVersionRange Parse(string range, int maxLength = MaxRangeLength)
#pragma warning restore RS0026 // Do not add multiple public overloads with optional parameters
        =>
...
#pragma warning disable RS0026 // Do not add multiple public overloads with optional parameters
    public static bool TryParse(
        string? range,
        SemVersionRangeOptions options,
        [NotNullWhen(true)] out SemVersionRange? semverRange,
        int maxLength = MaxRangeLength
    )
#pragma warning restore RS0026 // Do not add multiple public overloads with optional parameters
    {
        ...
        var exception = StandardRangeParser.Parse(
            range,
            options,
...
#pragma warning restore RS0026 // Do not add multiple public overloads with optional parameters
    ...
    )
    {
        ...
        var exception = NpmRangeParser.Parse(
            range,
            includeAllPrerelease,
            VersionParsing.FailedException,
            maxLength,
        ...
        DebugChecks.IsNotFailedException(
            exception,
            nameof(NpmRangeParser),
            nameof(NpmRangeParser.Parse)
        );
...
#pragma warning restore RS0026 // Do not add multiple public overloads with optional parameters
    ...
    /// otherwise <see langword="false"/>.</returns>
    public override bool Equals(object? obj) => obj is SemVersionRange other && Equals(other);
