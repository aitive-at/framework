...
/// </remarks>
public readonly struct MetadataIdentifier
    : IEquatable<MetadataIdentifier>,
        IComparable<MetadataIdentifier>,
        IComparable
{
    /// <summary>
    ...
    internal static MetadataIdentifier CreateUnsafe(string value)
    {
        ...
        if (!value.IsAlphanumericOrHyphens())
            throw new ArgumentException(
                $"DEBUG: A metadata identifier can contain only ASCII alphanumeric characters and hyphens '{value}'.",
                nameof(value)
            );
#endif
    ...
    internal MetadataIdentifier(string value, string paramName)
    {
        ...
        if (!value.IsAlphanumericOrHyphens())
            throw new ArgumentException(
                $"A metadata identifier can contain only ASCII alphanumeric characters and hyphens '{value}'.",
                paramName
            );
    ...
    public int CompareTo(MetadataIdentifier value) => IdentifierString.Compare(Value, value.Value);
    ...
    public int CompareTo(object? value)
    {
        ...
        return value is MetadataIdentifier other
            ...
            : throw new ArgumentException(
                $"Object must be of type {nameof(MetadataIdentifier)}.",
                nameof(value)
            );
    }
    #endregion
